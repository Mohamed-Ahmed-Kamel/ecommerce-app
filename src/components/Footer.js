...
import news from "../images/news-48.png";
function Footer() {
  return (
    <>
      <footer className="py-4">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-5">
              <div className="footer-top.data d-flex gap-30 align-items-center text-center">
          ...
          <div className="row">
            ...
            <div className="col-3">
              ...
              <div className="footer-links d-flex flex-column">
                ...
                <Link to="/refund-policy" className="text-white py-2 mb-1">Refoun Policy</Link>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by Dev Mohamed
              </p>
            </div>
          </div>
        </div>
